...
@Suppress("EnumEntryName")
enum class AndroidFlavor(val dimension: FlavorDimension, val applicationIdSuffix: String? = null) {
...
fun configureFlavors(
    ...
    commonExtension.apply {
        ...
        productFlavors {
            AndroidFlavor.values().forEach { niaFlavor ->
